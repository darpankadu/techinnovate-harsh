...
import Hero from "../components/Ambler250X/Hero"
import Specifications from "../components/Ambler250X/SpecificationX"
import BigText from "../components/Ambler250X/BigText"
...
const Ambler250X = () => {
  ...
  return (
    <div className="bg-bgPrimary font-LexendDeca overflow-hidden">
      ...
      />
      <Hero />
      <Specifications product="Ambler 250X"/>
      <BigText />
      <div className="changeBg" ref={changeBg}>
        ...
        <CardwithImage
          text={
            "Ambler 250X have cruise control which can help in walking effectively. You can set the speed of treadmill/vehicle and it can stop by applying the brakes."
          }
        />
      </div>
